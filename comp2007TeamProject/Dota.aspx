        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                ...
                <asp:GridView runat="server" CssClass="table table-bordered table-striped table-hover"
                    ...
                    <Columns>
                        ...
                        <%-- <asp:BoundField DataField="weekOfGame" HeaderText="Week" Visible="true" SortExpression="weekOfGame" />--%>
                          ...
                          <asp:HyperLinkField HeaderText="Edit" Text="<i class='fa fa-pencil-square-o fa-lg'></i> Edit" 
                            NavigateUrl="~/DotaDetails.aspx.cs" ControlStyle-CssClass="btn btn-primary btn-sm" runat="server"
                            DataNavigateUrlFields="gameID" DataNavigateUrlFormatString="DotaDetails.aspx?gameID={0}" />
                 ...
                 <a href="DotaDetails.aspx" class="btn btn-success btn-md">Add Game Stats</a>
            </div>
        </div>
    </div>
</asp:Content>
